...
__decorate([
    (0, class_validator_1.IsString)({ message: 'Le nom doit être du texte' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Le nom est obligatoire' }),
    (0, class_validator_1.Length)(2, 100, { message: 'Le nom doit avoir entre 2 et 100 caractères' }),
    __metadata("design:type", String)
], CreateClientDto.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'Le prénom doit être du texte' }),
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Le téléphone est obligatoire' }),
    __metadata("design:type", String)
